...
Voor het daadwerkelijk ontwikkelen van software zijn er een aantal belangrijke commands vanuit Git die hierbij helpen. We hebben tot nu alleen nog echt gehad over het delen van projecten, maar vanaf dit punt gaan we wat meer in op het bijdragen aan de broncode.

### Core commands:

Net als bij het verkrijgen van ontwikkelingsmiddelen zijn er bij het ontwikkelen ervan 4 hoofd commands (core commands) die binnen Git vaak worden gebruikt om bijdrages/veranderingen door te voeren:
